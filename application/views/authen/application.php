		  ...
		  <div class="layout">
					<div id="freewall" class="free-wall">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>สิทธิ์การใช้งาน</strong></div>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>การลา</strong></div>
								<div class="cover default-flat">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>จองรถยนต์</strong></div>
								<div class="cover default-flat">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>จองห้องประชุม</strong></div>
								<div class="cover default-flat">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>ข่าวประชาสัมพันธ์</strong></div>
								<div class="cover default-flat">
									<img class="myImg img-responsive" src="<?php  echo base_url("assets/images/application_icon/books.png"); ?>" />
								</div>
								<div class="col-lg-12 role-detail font-thsan">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>ติดตามงานบุคคล</strong></div>
								<div class="cover default-flat">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>สารบัญ</strong></div>
								<div class="cover default-flat">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>นัดหมาย</strong></div>
								<div class="cover default-flat">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>เงินเดือน</strong></div>
								<div class="cover default-flat">
									<img class="myImg img-responsive" src="<?php  echo base_url("assets/images/application_icon/business-card.png"); ?>" />
								</div>
								<div class="col-lg-12 role-detail font-thsan">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>การเงิน</strong></div>
								<div class="cover default-flat">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>งบประมาณ</strong></div>
								<div class="cover default-flat">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>จัดการเอกสาร</strong></div>
								<div class="cover default-flat">
									<img class="myImg img-responsive" src="<?php  echo base_url("assets/images/application_icon/bag.png"); ?>" />
								</div>
								<div class="col-lg-12 role-detail font-thsan">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>งานบุคลากร</strong></div>
								<div class="cover default-flat">
									<img class="myImg img-responsive" src="<?php  echo base_url("assets/images/application_icon/business-card.png"); ?>" />
								</div>
								<div class="col-lg-12 role-detail font-thsan">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 margin-bottom-30">
							<div class="cell">
								<div class="head-title font-thsan" align="center"><strong>เชื่อมโยงข้อมูลบุคลากร</strong></div>
								<div class="cover default-flat">
