<?php
$header = '
<table class="tbl_header" border="0" width="100%" cellspacing="0" cellpadding="0"><tr>
...
<div>
	...
	<div align="center" style="font-size:25pt; font-weight:bold;">พระบรมราโชวาทและพระราชดำรัสของพระบาทสมเด็จพระเจ้าอยู่หัว</div>
	<br>
	<div align="center">
...
//------------------------------------------------------------------------------------------------------------------
$footer = '
<table class="tbl_footer" border="0" width="100%" cellspacing="0" cellpadding="0"><tr>
...
//$mpdf=new mPDF(); 
//$mpdf=new mPDF('th', 'A4-L', '0', 'krrthaispirit'); 
$mpdf=new mPDF('th', 'A4', '0', 'thsaraban', 15,15,20,20,5,5); 
$css = '';
$css .= '<style>'.file_get_contents('../assets/css/style.css').'</style>'; // external css
$mpdf->WriteHTML($css);
